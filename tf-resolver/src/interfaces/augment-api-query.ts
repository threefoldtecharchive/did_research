...
import { AccountId, Balance, BlockNumber, ExtrinsicsWeight, Hash, Moment, Releases } from '@polkadot/types/interfaces/runtime';
...
import { KycObject } from 'tf-resolver/interfaces/templateModule';
...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    templateModule: {
      kycAttrs: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<Vec<KycObject>>>;
    };
    timestamp: {
      /**
